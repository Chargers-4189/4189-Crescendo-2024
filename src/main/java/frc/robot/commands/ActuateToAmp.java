...
public class ActuateToAmp extends Command {
  ...
  private AbsoluteEncoderSetpoint ampEncoder = new AbsoluteEncoderSetpoint(ampSystem.getEncoderObject(), Constants.AmpSystemConstants.kEncoderAmpPosition, true);
